...
if (Config.WORKTYPE == 'private') {
    ...
    Garfield.addXnodes({pattern: 'anhdme', fromMe: true, desc: 'random anime image'}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: 'Made by Garfield'})

    }));
    
    Garfield.addXnodes({pattern: 'walaper', fromMe: true, desc: Lang.WP}, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid, Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: ' ```GARFIELD 🐼                                                                                                                                                                                          Follow Developer Instagram - https://www.instagram.com/liyanage_tharindu_?r=nametag``` '})

    }));
    
    Garfield.addXnodes({pattern: 'pindhehehk', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
await message.sendMessage(r_text[i]);
    ...
    Garfield.addXnodes({pattern: 'menu', fromMe: false, desc:'random anime image '}, (async (message, match) => {
